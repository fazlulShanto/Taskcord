...
export function FeaturesSection() {
  ...
  const features = [
    {
      ...
      highlights: ['Slash commands', 'In-channel boards', 'Thread-based discussions', 'Inline updates'],
  ...
  return (
    <section ref={ref} className="relative bg-gradient-to-b from-slate-900 to-gray-900 py-24 sm:py-32">
          ...
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute -inset-px rounded-3xl bg-gradient-to-r ${feature.gradient} opacity-0 transition-opacity group-hover:opacity-100`} />
                ...
                <div className="relative h-full rounded-3xl border border-white/10 bg-gray-800/50 p-8 backdrop-blur-sm transition-all group-hover:border-transparent">
                  {/* Icon */}
                  <div className={`mb-6 inline-flex rounded-2xl bg-gradient-to-r ${feature.gradient} p-4`}>
      ...
      <div className="absolute left-0 top-1/4 h-96 w-96 -translate-x-1/2 rounded-full bg-blue-500/10 blur-3xl" />
