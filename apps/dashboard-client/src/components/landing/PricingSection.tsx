...
export function PricingSection() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-gray-900 to-slate-900 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          {plans.map((plan, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute -inset-px rounded-3xl bg-gradient-to-b ${
                  plan.popular 
        ...
        >
          <p className="text-gray-400">
            All plans include our core features. <span className="text-white font-semibold">No credit card required</span> to start.
          </p>
          <p className="mt-2 text-sm text-gray-500">
            Questions about pricing? <a href="#" className="text-blue-400 hover:underline">Contact our team</a>
          </p>
        </motion.div>
      </div>

      {/* Decorative gradients */}
      <div className="absolute left-0 top-1/2 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 blur-3xl" />
      <div className="absolute right-0 top-0 h-[600px] w-[600px] translate-x-1/2 rounded-full bg-gradient-to-r from-purple-500/10 to-pink-500/10 blur-3xl" />
    </section>
  );
}
