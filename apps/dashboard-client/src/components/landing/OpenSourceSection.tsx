...
export function OpenSourceSection() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-gradient-to-b from-gray-900 via-slate-900 to-gray-900 py-24 sm:py-32">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <p className="mb-8 text-lg text-gray-300">
              Task Waku is built on open-source principles. We believe in transparency, community collaboration, 
              and giving you complete control over your project management tools.
            </p>
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              <Button
                size="lg"
                className="group gap-2 bg-purple-600 hover:bg-purple-700"
              >
            ...
            >
              <div className="overflow-hidden rounded-2xl border border-white/10 bg-gray-800/50 p-6 backdrop-blur-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-400">Active development & community contributions</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      {/* Decorative gradient */}
      <div className="absolute left-1/2 top-0 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-gradient-to-r from-purple-500/10 to-pink-500/10 blur-3xl" />
    </section>
  );
}
