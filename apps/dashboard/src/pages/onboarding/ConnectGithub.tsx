  ...
  const renderStepHeader = () => {
    return (
      <div className="bg-background sticky -top-0.5 z-10 p-3">
        <h2 className="text-primary text-xl font-bold">GitHub Integration</h2>
  ...
  return (
    <div className="relative">
      ...
      <div className="relative flex flex-col items-center justify-center p-6">
        <div className="relative w-full max-w-2xl transform rounded-xl bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 p-8 text-white shadow-2xl transition-transform">
          <div className="absolute -top-2 -right-2 animate-bounce">
            <div className="flex items-center rounded-full bg-white/90 px-3 py-1 text-xs font-bold tracking-wider text-purple-600 uppercase shadow-lg">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <svg className="mt-1 h-5 w-5 shrink-0" fill="currentColor" viewBox="0 0 24 24">
