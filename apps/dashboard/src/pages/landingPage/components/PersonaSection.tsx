...
export function PersonaSection() {
  ...
  return (
    <section ref={ref} className="relative bg-gray-900 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-400">
            Designed for small software teams, agile marketers, and indie creators who value
            Discord's collaborative community vibe.
          </p>
        </motion.div>
              ...
              >
                ...
                <div className="relative h-full rounded-2xl border border-white/10 bg-gray-800/50 p-8 backdrop-blur-sm">
                  ...
                  <div className="mb-6 border-l-4 border-purple-500 bg-purple-500/10 p-4">
                    <p className="text-gray-300 italic">"{persona.quote}"</p>
                  </div>
        ...
        >
          <p className="text-xl font-semibold text-white">Does this sound like you?</p>
      ...
      {/* Decorative elements */}
      <div className="absolute top-1/2 right-0 h-96 w-96 translate-x-1/2 rounded-full bg-purple-500/10 blur-3xl" />
    </section>
  );
}
