...
export function SolutionSection() {
  ...
  return (
    <section
      ref={ref}
      className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-blue-900 to-slate-900 py-24 sm:py-32"
    >
            ...
            <div className="mb-8 space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Turn Discord into a command center. Manage everything without ever leaving your
                    chat.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Your code and tasks stay perfectly aligned. Issues, PRs, comments—all synced in
                    real-time.
                  </p>
                </div>
              </div>
          ...
          >
            ...
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -top-6 -right-6 rounded-xl border border-white/10 bg-gray-900/90 p-4 backdrop-blur-sm"
              >
      ...
      {/* Decorative gradient */}
      <div className="absolute top-1/2 left-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-blue-500/10 to-cyan-500/10 blur-3xl" />
    </section>
  );
}
