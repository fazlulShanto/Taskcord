...
export function ProblemSection() {
  ...
  const problems = [
    {
      ...
      description:
        'Jump between Discord, GitHub, and your PM tool dozens of times a day. Each switch kills your focus and productivity.',
    ...
    },
    {
      ...
      description:
        'Critical task updates buried in Discord chat history. Important GitHub discussions disconnected from your board.',
    ...
    },
    {
      ...
      description:
        'Existing tools offer one-way syncs or complex third-party connectors like Zapier. Nothing truly unifies your workflow.',
    ...
    },
    {
      ...
      description:
        "Bloated PM tools with features you'll never use. Your team spends more time learning the tool than actually working.",
  ...
  return (
    <section
      ref={ref}
      className="relative bg-gradient-to-b from-gray-900 to-slate-900 py-24 sm:py-32"
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-400">
            You're not alone. Modern development teams are drowning in tool sprawl, and it's killing
            productivity.
          </p>
        </motion.div>
      ...
      {/* Decorative elements */}
      <div className="absolute top-1/2 left-0 h-96 w-96 -translate-x-1/2 rounded-full bg-red-500/10 blur-3xl" />
      <div className="absolute top-1/4 right-0 h-96 w-96 translate-x-1/2 rounded-full bg-orange-500/10 blur-3xl" />
    </section>
  );
}
