...
export function FinalCTASection() {
  ...
  return (
    <section
      ref={ref}
      className="relative overflow-hidden bg-gradient-to-b from-gray-900 via-blue-900 to-purple-900 py-24 sm:py-32"
    >
      {/* Animated background */}
      ...
      <div className="relative mx-auto max-w-4xl px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-semibold text-white">
              Join 500+ teams already using Task Waku
            </span>
          </motion.div>
        ...
        <div className="absolute -top-32 -right-32 h-64 w-64 rounded-full bg-purple-500/20 blur-3xl" />
      </div>
    </section>
  );
}
