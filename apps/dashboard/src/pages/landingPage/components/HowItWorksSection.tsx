  ...
  const steps = [
    {
      ...
      description:
        'Use intuitive slash commands to create, assign, and update tasks. No need to open another app.',
    ...
    },
    {
      ...
      description:
        'GitHub issues and PRs automatically become tasks. Comments, status changes, and labels sync instantly.',
    ...
    },
    {
      ...
      description:
        'See your Kanban board, timelines, burndown charts, and team analytics in a beautiful dashboard.',
              ...
              >
                ...
                <div className={`flex flex-col justify-center ${isEven ? '' : 'lg:col-start-2'}`}>
                  <div className="mb-6 flex items-center gap-4">
                    <span
                      className={`bg-gradient-to-r ${step.gradient} bg-clip-text text-6xl font-bold text-transparent`}
                    >
                      {step.number}
                    </span>
                  ...
                  <h3 className="mb-4 text-3xl font-bold text-white sm:text-4xl">{step.title}</h3>

                  <p className="mb-6 text-lg text-gray-400">{step.description}</p>
                ...
                <div className={`relative ${isEven ? '' : 'lg:col-start-1 lg:row-start-1'}`}>
                  <div
                    className={`absolute -inset-4 rounded-3xl bg-gradient-to-r ${step.gradient} opacity-20 blur-3xl`}
                  />
